...
DATA_DIR = r'C:\Users\shamika\OneDrive - Althouse & Meade, Inc\Desktop'
...
def get_data_for_date(mac_address, target_date, retries=3, delay=5):
    """Fetch data for a specific date for a given station."""
...
def main():
    """Fetch and save weather data from May 1 to May 8, 2024."""
